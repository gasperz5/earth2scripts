    ...
    async function start() {
        while (true) {
            if (document.getElementsByClassName('flex flex-shrink-0 self-center')[0] != null) {
                ...
                document.getElementsByClassName('flex flex-shrink-0 self-center')[0].getElementsByTagName('div')[13].getElementsByClassName("inline-flex items-center")[0].addEventListener("mousedown", lc);
                document.getElementsByClassName('flex flex-shrink-0 self-center')[0].getElementsByTagName('div')[13].getElementsByClassName("inline-flex items-center")[1].addEventListener("mousedown", fp);
