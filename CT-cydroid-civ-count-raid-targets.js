...
(async function () {
    ...
    async function checker() {
        ...
        let head = document.querySelector("table.table-fixed.styles_table__1nN0M > thead > tr");
        if (head == null) return;
        ...
        for (const [key, value] of myMap) {
            ...
            let element = document.querySelector("table.table-fixed.styles_table__1nN0M > tbody > tr:nth-child(" + i + ")");
